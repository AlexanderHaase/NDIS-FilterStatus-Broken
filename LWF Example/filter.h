...
#define FILTER_FRIENDLY_NAME        L"LWFExample NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{ffa73bd3-6c3b-457e-922c-702c34ca438b}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"LWFExample"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\LWFExample"
#define NTDEVICE_STRING             L"\\Device\\LWFExample"
...
DRIVER_DISPATCH LWFExampleDispatch;

DRIVER_DISPATCH LWFExampleDeviceIoControl;
